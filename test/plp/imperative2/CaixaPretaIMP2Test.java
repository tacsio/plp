...
public class CaixaPretaIMP2Test {
	...
	public CaixaPretaIMP2Test(String input, String resultado, boolean aceitoTipo, boolean aceitoValor
	...
	public static List<Object[]> data() {
		...
		data.addAll(UtilCaixaPreta.getEntradaImp2Test()); 		
		return data;
	}
